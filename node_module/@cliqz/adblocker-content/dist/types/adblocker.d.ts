...
export declare function getDOMElementsFromMutations(mutations: MutationRecord[]): DOMElement[];
/**
 ...
 * more details).
 */
export declare function extractFeaturesFromDOM(elements: DOMElement[]): {
    classes: string[];
    hrefs: string[];
    ids: string[];
};
