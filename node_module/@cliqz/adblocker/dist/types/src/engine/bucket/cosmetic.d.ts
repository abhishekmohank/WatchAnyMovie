...
export default class CosmeticFilterBucket {
     ...
     */
    getCosmeticsFilters({ domain, hostname, classes, hrefs, ids, allowGenericHides, allowSpecificHides, getBaseRules, getInjectionRules, getRulesFromDOM, getRulesFromHostname, }: {
        domain: string;
        hostname: string;
        classes?: string[];
        hrefs?: string[];
